...
public class Translate extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Translate English");

        jTextArea1.setColumns(20);
        jTextArea1.setRows(5);
        jScrollPane1.setViewportView(jTextArea1);

        jLabel2.setText("Into Pig Latin");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(input.charAt(0)!='a'&&input.charAt(0)!='e'&&input.charAt(0)!='i'&&input.charAt(0)!='o'&&input.charAt(0)!='u'){
            ...
            wordBefore = wordBefore + input.charAt(i);
        }
            wordAfter = wordBefore + input.charAt(0) + "ay";
            jTextArea2.setText(wordAfter);
        }else{
            wordAfter = input + "way";
            jTextArea2.setText(wordAfter);
        }
...
//        });
        ...
        frame.pack();
        frame.setTitle("Translation of English into Pig Latin");
